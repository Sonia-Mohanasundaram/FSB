...
import { Heart, LayoutDashboard, Stethoscope, CalendarCheck, LogOut, Menu } from "lucide-react";
...
const PatientLayout: React.FC = () => {
  ...
  return (
    <div className="min-h-screen w-full flex flex-col md:flex-row">
      ...
      <aside className="hidden md:flex w-64 flex-col bg-gradient-to-b from-primary to-blue-700 text-primary-foreground">
